                    ...
                    <div class="ad-auth-content">
                        <form action="" method="POST">
                            ...
                            <div class="ad-other-feilds">
                                ...
                                <a class="forgot-pws-btn" href="public/forgot-pws.html">Forgot Password?</a>
                            </div>
                            <div class="ad-auth-btn">
                                <button class="ad-btn ad-login-member">Login</button>
                            </div>
                            <p class="ad-register-text">Don't have an account? <a href="public/register.html">Click Here</a></p>
                        </form>
                    </div>
                </div>
            </div>
