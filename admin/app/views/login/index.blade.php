...
<!-- Mirrored from kamleshyadav.com/html/splashdash/HTML/bootstrep-5/splashdash-admin-template/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Nov 2022 09:36:52 GMT -->
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ad-auth-img">
                        <img src="public/assets/images/auth-img1.png" alt="" />
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ad-auth-content">
                        <form action="{{ router('login-post') }}" method="POST">
                            <a href="public/index.html" class="ad-auth-logo">
                            ...
                            <div class="ad-auth-form">
                                <div class="ad-auth-feilds mb-30">
                                    <input name="email" type="text" placeholder="Email Address" class="ad-input" />
                                ...
                                <div class="ad-auth-feilds">
                                    <input name="password" type="password" placeholder="Password" class="ad-input" />
                                    @if (isset($_SESSION['errors']))
                            ...
                            <div class="ad-auth-btn">
                                <button name="btn" class="ad-btn ad-login-member">Login</button>
                            </div>
                            <p class="ad-register-text">Don't have an account? <a href="public/register.html">Click
                                    Here</a></p>
                        </form>
                    </div>
                </div>
...
<!-- Mirrored from kamleshyadav.com/html/splashdash/HTML/bootstrep-5/splashdash-admin-template/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Nov 2022 09:36:53 GMT -->
